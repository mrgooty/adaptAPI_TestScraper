...
// Raw landing table for the Forleast Star website.
// 1:1 with src/models/forleast-star-raw-record.js.
//
...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable('ForleastStarRawRecords', {
      id: {
        allowNull: false,
        autoIncrement: true,
        primaryKey: true,
      ...
      // carrier's own shape (policy detail pages, endorsements table, etc.).
      payload: {
  ...
  async down(queryInterface) {
    await queryInterface.dropTable('ForleastStarRawRecords');
  },
};
